...
pipeline {
    ...
    parameters
    {
        ...
        string(name: 'aws_account_id', description: " AWS Account ID", defaultValue: '416514649666')
    ...
    environment{
        ...
        //ACCESS_KEY = credentials('my-aws-cred')
        //SECRET_KEY = credentials('my-aws-cre')
        AWS_CREDENTIALS = credentials('my-aws-cred')
    }
    ...
    stages{
        ...
        stage('Git Checkout'){
            ...
            gitCheckout(
                branch: "main",
                url: "https://github.com/mnforba/CI-CD-Project.git"
            )
            }
        }
